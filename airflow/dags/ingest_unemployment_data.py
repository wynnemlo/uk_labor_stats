...
with DAG(
    ...
    dag_id="ingest_unemployment_data",
    ...
    download_csv_to_local = ONSDownloadCSVOperator(
        ...
        url_prefix='https://www.ons.gov.uk/generator?format=csv&uri=/employmentandlabourmarket/peoplenotinwork/unemployment/timeseries/mgsx/lms/previous/v',
        filename_prefix='unemployment'
    )
