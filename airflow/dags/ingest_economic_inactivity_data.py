...
with DAG(
    ...
    dag_id="ingest_economic_inactivity_data",
    ...
    download_csv_to_local = ONSDownloadCSVOperator(
        ...
        url_prefix='https://www.ons.gov.uk/generator?format=csv&uri=/employmentandlabourmarket/peoplenotinwork/economicinactivity/timeseries/lf2m/lms/previous/v',
        filename_prefix='economic_inactivity'
    )
    ...
    transform_to_postgres = TransformToPostgresOperator(
        ...
        bucket=BUCKET,
        table_name="economic_inactivity",
        field_name="count_in_thousands"
    )
