...
with DAG(
    ...
    dag_id="ingest_male_employment_data",
    ...
    download_csv_to_local = ONSDownloadCSVOperator(
        ...
        url_prefix='https://www.ons.gov.uk/generator?format=csv&uri=/employmentandlabourmarket/peopleinwork/employmentandemployeetypes/timeseries/mgsv/lms/previous/v',
